...
\label{subsubsec:PF}
    ...
    \ctable {
        ...
        \cincl & \cincl & \cincl &
        Karekterláncok (string) és feldolgozásuk 
        ...
        \ccode & \ccode & \ccode & 
        A valós számok lebegőpontos reprezentációja, pontossági hibák léte.
        ...
        % \Icodeonly The floating-point representation of real numbers, the existence of precision issues.
...
\label{subsubsec:AL}
    ...
    \ctable {
        ...
        \ccode & \ccode & \ccode &
        Szokásos nagyságrendi osztályok: konstans, logaritmikus, lineáris, $\mathcal{O}(n \log n)$, négyzetes, köbös, exponenciális stb.
        ...
        \cnfoc & \cnfoc & \cnfoc &
        kis ordó, omega és theta jelölések
