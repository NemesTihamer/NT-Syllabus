...
\parindent 20 pt
\parskip 0 pt
\markboth{\sc Nemes Tihamér 2 Sillabusz\DRAFT}{\sc Nemes Tihamér 2 Sillabusz\DRAFT}
...
\label{subsubsec:PF}
    ...
    \begin{myitemize}
    \Iincluded\CC{Alapvető szintaxisa és szemantikája egy versenyen megengedett programozási nyelvnek} % {Basic syntax and semantics of a higher-level language} 
    \Iincluded\CC{Változók, típusok, műveletek, kifejezések és értékadás} % {Variables, types, expressions, and assignment}
    \Iincluded\CC{Egyszerű beolvasás és kiírás} (A standard input/output ismerete kell.) % {Simple I/O}
    \Iexmaybe \CC{Fájlba írás és olvasás}
    \Iincluded\CC{Elágazások és ciklusok}  % {Conditional and iterative control structures}
    \Iincluded\CC{Függvények és paraméterátadás} % {Functions and parameter passing}
    \end{myitemize}
