...
\subsection {Diszkrét matematika} % {Discrete Structures (DS)}
\label{subsubsec:DS}

\subsubsection*{DS1. Halmazok, relációk és függvények}
...
\subsubsection*{DS2. Matematikai logika} % {DS2. Basic logic}
...
\subsubsection*{DS3. Bizonyítási módszerek} % DS3. Proof techniques
...
\subsubsection*{DS4. Kombinatorika: leszámlálások} % DS4. Basics of counting
